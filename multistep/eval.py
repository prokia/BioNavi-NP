...
def get_dict_from_log(pth):  # obatin ditct from ouput log
    '''
...
def compare(ori_path, pred_path):  # obtain the overlapped parts between predicted paths and ground truths
    '''
